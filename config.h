...
static const unsigned BG_OFFSETS[]     = { 0,   0 };
static const unsigned BALL_OFFSETS[]   = { 510, 0 };
static const unsigned PADDLE_OFFSETS[] = { 384, 0 };
static const unsigned BRICK_OFFSETS[][IND_COUNT] = {
